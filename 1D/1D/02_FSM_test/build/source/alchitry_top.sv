...
module alchitry_top (
    ...
    localparam _MP_STAGES_1041561485 = 3'h4;
    logic M_reset_cond_in;
    logic M_reset_cond_out;
    
    reset_conditioner #(
        .STAGES(_MP_STAGES_1041561485)
    ) reset_cond (
        .clk(clk),
        .in(M_reset_cond_in),
    ...
    localparam _MP_RISE_1448931084 = 1'h1;
    localparam _MP_FALL_1448931084 = 1'h0;
    logic M_pulseEdge_in;
    logic M_pulseEdge_out;
    
    edge_detector #(
        .RISE(_MP_RISE_1448931084),
        .FALL(_MP_FALL_1448931084)
    ) pulseEdge (
        .clk(clk),
        .in(M_pulseEdge_in),
        .out(M_pulseEdge_out)
    ...
    localparam _MP_CLK_FREQ_506808073 = 27'h5f5e100;
    localparam _MP_MIN_DELAY_506808073 = 5'h14;
    localparam _MP_NUM_SYNC_506808073 = 2'h2;
    logic M_start_cond_out;
    
    button_conditioner #(
        .CLK_FREQ(_MP_CLK_FREQ_506808073),
        .MIN_DELAY(_MP_MIN_DELAY_506808073),
        .NUM_SYNC(_MP_NUM_SYNC_506808073)
    ) start_cond (
        .in(io_button[3'h4]),
        .clk(clk),
    ...
    localparam _MP_RISE_1312360603 = 1'h1;
    localparam _MP_FALL_1312360603 = 1'h0;
    logic M_start_edge_out;
    
    edge_detector #(
        .RISE(_MP_RISE_1312360603),
        .FALL(_MP_FALL_1312360603)
    ) start_edge (
        .in(M_start_cond_out),
        .clk(clk),
    ...
    localparam _MP_DIGITS_848752234 = 3'h6;
    localparam _MP_DIV_848752234 = 5'h10;
    logic [5:0][3:0] M_seg_values;
    logic [6:0] M_seg_seg;
    logic [5:0] M_seg_sel;
    
    multi_seven_seg #(
        .DIGITS(_MP_DIGITS_848752234),
        .DIV(_MP_DIV_848752234)
    ) seg (
        .clk(clk),
        .rst(rst),
        .values(M_seg_values),
    ...
    localparam _MP_DIGITS_1535639762 = 2'h2;
    localparam _MP_MODE_1535639762 = 1'h1;
    logic M_timer_inc;
    logic [1:0][3:0] M_timer_start;
    logic [1:0][3:0] M_timer_digits;
    
    multi_decimal_counter #(
        .DIGITS(_MP_DIGITS_1535639762),
        .MODE(_MP_MODE_1535639762)
    ) timer (
        .limit({{4'h0, 4'h0}}),
        .clk(clk),
        .rst(rst),
    ...
    localparam _MP_DIGITS_728290 = 2'h2;
    localparam _MP_MODE_728290 = 1'h0;
    logic M_pts_ctr_inc;
    logic [1:0][3:0] M_pts_ctr_digits;
    
    multi_decimal_counter #(
        .DIGITS(_MP_DIGITS_728290),
        .MODE(_MP_MODE_728290)
    ) pts_ctr (
        .start({{4'h0, 4'h0}}),
        .limit({{4'h9, 4'h9}}),
        .clk(clk),
    ...
    localparam _MP_SIZE_1158175340 = 1'h1;
    localparam _MP_DIV_1158175340 = 5'h18;
    localparam _MP_TOP_1158175340 = 1'h0;
    localparam _MP_UP_1158175340 = 1'h1;
    logic [0:0] M_pulse_value;
    
    counter #(
        .SIZE(_MP_SIZE_1158175340),
        .DIV(_MP_DIV_1158175340),
        .TOP(_MP_TOP_1158175340),
        .UP(_MP_UP_1158175340)
    ) pulse (
        .clk(clk),
        .rst(rst),
        .value(M_pulse_value)
    ...
    localparam _MP_SIZE_1671611606 = 4'h8;
    logic [7:0] M_alu_a;
    logic [7:0] M_alu_b;
    logic M_alu_z;
    logic M_alu_v;
    ...
    localparam _MP_COLUMN_DIMENSION_1531834271 = 3'h4;
    localparam _MP_ROW_DIMENSION_1531834271 = 1'h1;
    localparam _MP_PIXEL_COUNT_1531834271 = 3'h4;
    localparam _MP_BUFFER_SIZE_1531834271 = 4'hc;
    logic [2:0] M_colourCtr_selColour;
    logic M_colourCtr_data;
    
    toggle_mode #(
        .COLUMN_DIMENSION(_MP_COLUMN_DIMENSION_1531834271),
        .ROW_DIMENSION(_MP_ROW_DIMENSION_1531834271),
        .PIXEL_COUNT(_MP_PIXEL_COUNT_1531834271),
        .BUFFER_SIZE(_MP_BUFFER_SIZE_1531834271)
    ) colourCtr (
        .clk(clk),
        .rst_n(rst),
