...
set_property PACKAGE_PIN T8 [get_ports {io_dip[0][4]}]
...
set_property PACKAGE_PIN T7 [get_ports {io_dip[0][6]}]
...
set_property PACKAGE_PIN R7 [get_ports {io_dip[1][0]}]
...
set_property PACKAGE_PIN R6 [get_ports {io_dip[1][2]}]
...
set_property PACKAGE_PIN T5 [get_ports {io_dip[1][4]}]
...
set_property PACKAGE_PIN R5 [get_ports {io_dip[2][0]}]
...
set_property PACKAGE_PIN T9 [get_ports {io_dip[2][2]}]
...
set_property PACKAGE_PIN C1 [get_ports {io_segment[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {io_segment[0]}]

set_property PACKAGE_PIN H5 [get_ports {io_segment[1]}]
...
set_property PACKAGE_PIN C3 [get_ports {io_segment[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {io_segment[3]}]

set_property PACKAGE_PIN E3 [get_ports {io_segment[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {io_segment[4]}]

set_property PACKAGE_PIN D4 [get_ports {io_segment[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {io_segment[5]}]

set_property PACKAGE_PIN G5 [get_ports {io_segment[6]}]
