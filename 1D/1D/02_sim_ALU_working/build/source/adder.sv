...
module adder #(
    ...
    logic carry_in;
    localparam _MP_SIZE_1929483596 = SIZE;
    logic [(_MP_SIZE_1929483596)-1:0] M_rca_inst_a;
    logic [(_MP_SIZE_1929483596)-1:0] M_rca_inst_b;
    logic M_rca_inst_carry_out;
    logic [(_MP_SIZE_1929483596)-1:0] M_rca_inst_sum;
    
    adder_rca #(
        .SIZE(_MP_SIZE_1929483596)
    ) rca_inst (
        .a(M_rca_inst_a),
        .b(M_rca_inst_b),
    ...
    localparam _MP_SIZE_254106459 = SIZE;
    logic [(_MP_SIZE_254106459)-1:0] M_twos_comp_inst_b;
    logic [(_MP_SIZE_254106459)-1:0] M_twos_comp_inst_out;
    
    twos_complement #(
        .SIZE(_MP_SIZE_254106459)
    ) twos_comp_inst (
