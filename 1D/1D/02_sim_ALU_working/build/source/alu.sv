...
module alu #(
    ...
    logic overflow_flag;
    logic negative_flag;
    localparam _MP_SIZE_2044348772 = SIZE;
    logic [(_MP_SIZE_2044348772)-1:0] M_adder_inst_a;
    logic [(_MP_SIZE_2044348772)-1:0] M_adder_inst_b;
    logic [0:0] M_adder_inst_alufn;
    logic [(_MP_SIZE_2044348772)-1:0] M_adder_inst_out;
    logic M_adder_inst_zero_flag;
    logic M_adder_inst_overflow_flag;
    logic M_adder_inst_negative_flag;
    
    adder #(
        .SIZE(_MP_SIZE_2044348772)
    ) adder_inst (
        .a(M_adder_inst_a),
        .b(M_adder_inst_b),
    ...
    localparam _MP_SIZE_137256344 = SIZE;
    logic [(_MP_SIZE_137256344)-1:0] M_multiplier_inst_a;
    logic [(_MP_SIZE_137256344)-1:0] M_multiplier_inst_b;
    logic [0:0] M_multiplier_inst_alufn;
    logic [(_MP_SIZE_137256344)-1:0] M_multiplier_inst_out;
    
    multiplier #(
        .SIZE(_MP_SIZE_137256344)
    ) multiplier_inst (
    ...
    localparam _MP_SIZE_2076483842 = SIZE;
    logic [(_MP_SIZE_2076483842)-1:0] M_divider_inst_a;
    logic [(_MP_SIZE_2076483842)-1:0] M_divider_inst_b;
    logic [0:0] M_divider_inst_alufn;
    logic [(_MP_SIZE_2076483842)-1:0] M_divider_inst_out;
    logic [(_MP_SIZE_2076483842)-1:0] M_divider_inst_rem;
    
    divider #(
        .SIZE(_MP_SIZE_2076483842)
    ) divider_inst (
        .a(M_divider_inst_a),
        .b(M_divider_inst_b),
    ...
    localparam _MP_SIZE_389179610 = SIZE;
    logic [(_MP_SIZE_389179610)-1:0] M_boolean_inst_a;
    logic [(_MP_SIZE_389179610)-1:0] M_boolean_inst_b;
    logic [2:0] M_boolean_inst_alufn;
    logic [(_MP_SIZE_389179610)-1:0] M_boolean_inst_out;
    
    boolean #(
        .SIZE(_MP_SIZE_389179610)
    ) boolean_inst (
        .a(M_boolean_inst_a),
        .b(M_boolean_inst_b),
    ...
    localparam _MP_SIZE_90274689 = SIZE;
    logic [(_MP_SIZE_90274689)-1:0] M_shifter_inst_a;
    logic [(_MP_SIZE_90274689)-1:0] M_shifter_inst_b;
    logic [1:0] M_shifter_inst_alufn;
    logic [(_MP_SIZE_90274689)-1:0] M_shifter_inst_out;
    
    shifter #(
        .SIZE(_MP_SIZE_90274689)
    ) shifter_inst (
        .a(M_shifter_inst_a),
        .b(M_shifter_inst_b),
    ...
    localparam _MP_SIZE_946746096 = SIZE;
